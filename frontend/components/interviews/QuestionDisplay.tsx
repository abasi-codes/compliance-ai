...
export function QuestionDisplay({
  ...
  return (
    <Card animated className="overflow-hidden">
      {/* Question Header */}
      <div className="px-6 py-4 bg-gradient-to-r from-primary-50 via-primary-50/50 to-transparent border-b border-slate-200">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm text-slate-500">
              Question <span className="font-semibold text-slate-700">{questionNumber}</span> of {totalQuestions}
            </span>
          </div>
