  ...
  if (controls.length === 0) {
    return (
      <div className="text-center py-16 animate-fadeIn">
        ...
        <h3 className="text-base font-semibold text-neutral-900">No controls uploaded yet</h3>
        <p className="mt-2 text-sm text-neutral-500">Upload a CSV or XLSX file to get started</p>
      </div>
    );
  }
            ...
            {controls.map((control, index) => (
              ...
              >
                ...
                <td className="px-6 py-4">
                  <div className="max-w-xs truncate text-sm text-neutral-900" title={control.name}>
                    {control.name}
                  </div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-neutral-500">
                  {control.owner || <span className="text-neutral-300">-</span>}
                </td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-neutral-500">
                  {control.control_type || <span className="text-neutral-300">-</span>}
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <span
                    className={cn(
