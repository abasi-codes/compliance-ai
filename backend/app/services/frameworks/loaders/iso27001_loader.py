"""Loader for ISO/IEC 27001:2022 Information Security Management System."""
...
class Iso27001Loader(BaseFrameworkLoader):
    """Loader for ISO/IEC 27001:2022.

    Loads the ISO 27001:2022 framework with its Annex A controls.
    The framework has 2 hierarchy levels:
    - Level 0: Themes/Clauses (Organizational, People, Physical, Technological)
    - Level 1: Controls (93 controls) - assessable
    """

    def get_framework_data(self) -> FrameworkData:
        """Get ISO 27001:2022 framework data."""
        themes = self._get_annex_a_controls()
        ...
        return FrameworkData(
            ...
            version="2022",
            description=(
                "ISO/IEC 27001:2022 specifies the requirements for establishing, "
                "implementing, maintaining and continually improving an information "
                "security management system (ISMS). Annex A contains 93 controls "
                "organized into 4 themes: Organizational, People, Physical, and Technological."
            ),
            framework_type=FrameworkType.ISO_27001,
            hierarchy_levels=2,
            hierarchy_labels=["Theme", "Control"],
            metadata={
                "official_url": "https://www.iso.org/standard/82875.html",
                "total_themes": 4,
                "total_controls": 93,
    ...
    def _get_annex_a_controls(self) -> list[RequirementData]:
        """Get all Annex A controls organized by theme."""
        return [
            self._organizational_controls(),
            self._people_controls(),
            self._physical_controls(),
            self._technological_controls(),
        ]

    def _organizational_controls(self) -> RequirementData:
        ...
        controls = [
            ...
            ("5.13", "Labelling of information", "An appropriate set of procedures for information labelling shall be developed and implemented in accordance with the information classification scheme adopted by the organization."),
            ...
            ("5.21", "Managing information security in the ICT supply chain", "Processes and procedures shall be defined and implemented to manage the information security risks associated with the ICT products and services supply chain."),
            ...
            ("5.34", "Privacy and protection of PII", "The organization shall identify and meet the requirements regarding the preservation of privacy and protection of PII according to applicable laws and regulations and contractual requirements."),
        ...
        return RequirementData(
            ...
            description="Controls related to organizational policies, procedures, and management of information security.",
            level=0,
            is_assessable=False,
            display_order=0,
            ...
            children=[
                ...
                for idx, (code, name, desc) in enumerate(controls)
            ],
        )

    def _people_controls(self) -> RequirementData:
    ...
    def _physical_controls(self) -> RequirementData:
    ...
    def _technological_controls(self) -> RequirementData:
        ...
        return RequirementData(
            ...
            description="Controls related to technology, systems, and network security.",
            level=0,
            is_assessable=False,
            display_order=3,
            metadata={"control_count": len(controls)},
